...
import batb from "../image/poster.jpg";
...
function Register() {
  ...
  return (
    ...
    <div className="flex h-[36rem] w-[50rem] rounded-xl overflow-hidden shadow-2xl bg-white">
      <div className="w-1/3">
        <img src={batb} alt="poster" className="object-cover h-full w-full" />
      </div>
      <div className="flex flex-col bg-white bg-opacity-70 w-2/3 p-10 gap-4 text-black">
        <div className="flex flex-col gap-2 mb-2">
          ...
          <div className=" text-gray-600 text-center">Create Your Account in MyRecipe App</div>
        </div>
